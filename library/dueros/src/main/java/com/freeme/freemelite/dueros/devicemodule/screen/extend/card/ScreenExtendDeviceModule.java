 ...
 */
package com.freeme.freemelite.dueros.devicemodule.screen.extend.card;
...
import com.freeme.freemelite.dueros.devicemodule.screen.extend.card.message.RenderAirQualityPayload;
import com.freeme.freemelite.dueros.devicemodule.screen.extend.card.message.RenderAudioListPlayload;
import com.freeme.freemelite.dueros.devicemodule.screen.extend.card.message.RenderDatePayload;
import com.freeme.freemelite.dueros.devicemodule.screen.extend.card.message.RenderPlayerInfoPayload;
import com.freeme.freemelite.dueros.devicemodule.screen.extend.card.message.RenderStockPayload;
import com.freeme.freemelite.dueros.devicemodule.screen.extend.card.message.RenderTrafficRestrictionPayload;
import com.freeme.freemelite.dueros.devicemodule.screen.extend.card.message.RenderWeatherPayload;
...
public class ScreenExtendDeviceModule extends BaseDeviceModule {
    ...
    public void handleDirective(Directive directive) throws HandleDirectiveException {
        Log.e("liqi", ">>>>>>>>>>>>>handleDirective:" + directive.toString());
