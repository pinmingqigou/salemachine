...
#okhttp3
-dontwarn com.baidu.dcs.okhttp3.**
-dontwarn okio.**
...
-keep class com.freeme.freemelite.dueros.devicemodule.screen.ApiConstants{*;}
-keep class com.freeme.freemelite.dueros.devicemodule.screen.ApiConstants$*{*;}
...
-keep public class com.freeme.freemelite.router.payload.**{*;}
-keepclasseswithmembers class * extends com.baidu.duer.dcs.util.message.Payload{
    <fields>;
    <methods>;
}

-keep class com.freeme.freemelite.dueros.** { *; }
-keep class com.baidu.chenxiaojian.oauth.** { *; }
-keep class com.freeme.freemelite.router.** { *; }
-keep class com.freeme.freemelite.salemachine.** { *; }
